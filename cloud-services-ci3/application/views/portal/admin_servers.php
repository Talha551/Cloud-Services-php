<div>
    ...
    <div class="bg-[#13151f] border border-[#2a2d3e] rounded-xl overflow-hidden">
        <div class="grid grid-cols-6 px-5 py-3 text-xs uppercase tracking-wide text-slate-500 border-b border-[#2a2d3e]"><div>Name</div><div>Status</div><div>IP</div><div>OS</div><div>Plan</div><div></div></div>
        <?php foreach ($rows as $row): ?>
            ...
            <div class="grid grid-cols-6 px-5 py-3 text-sm border-b border-[#1e2130] last:border-0">
